...
export default function Ourservice() {
  const [autoplay, setAutoplay] = useState<
    false | { delay: number; disableOnInteraction: boolean }
  >(false);
                  ...
                  {({ isActive }) => (
                    <Link href={service.href} aria-label={`Learn more about ${service.text}`}>
                      ...
                      >
                        ...
                        {isActive && <div className="services_active absolute inset-0 -z-10" />}
                      </div>
                    </Link>
                  )}
                </SwiperSlide>
