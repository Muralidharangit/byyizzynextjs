  ...
  return (
    <form className="space-y-4" ref={formRef} onSubmit={handleSubmit}>
      ...
      <button
        type="submit"
        disabled={loading}
        className="w-full rounded-lg bg-[#067afd] px-6 py-3 font-medium text-white shadow-md transition hover:bg-blue-700 hover:shadow-lg disabled:opacity-60 md:w-auto"
      >
